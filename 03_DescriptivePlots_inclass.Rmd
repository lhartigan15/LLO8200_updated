...
gg<-ggplot(at_sum_bizgen, aes(x=fct_reorder(BusinessTravel, attr_avg), y=attr_avg, color=Gender))
...
There are a multitude of resources online for customizing your ggplots. This one has some good info for barplots with step-by-step directions for customizations. [Link:](http://www.sthda.com/english/wiki/ggplot2-barplots-quick-start-guide-r-software-and-data-visualization)
