...
6. Let's plot the proportion of lemons by a third independent variable of interest: odometer reading (`VehOdo`). Because this variable is continuous, we should use a scatterplot to examine a possible association with our outcome. (6pts)
```{r}
