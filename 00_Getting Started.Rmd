...
pacman::p_load(caret,flexclust,forcats,ggpubr,glmnet,gridExtra,knitr, 
               ...
               tidycensus,tidymodels,tidyverse,tigris,yardstick)
```
...
#NOTE: You MUST comment out line 74 OR change this to a path on your computer before knitting - don't forget, you still need the file name at the end
```
