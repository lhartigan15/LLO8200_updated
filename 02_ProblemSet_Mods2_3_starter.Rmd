...
For this research question, we're interested in understanding more about what predicts alumni earnings for a set of postsecondary institutions. We have a limited dataset (only 125 institutions) but we hope that (eventually) we could use the information about potential predictors from this study to inform predictions about a larger set of colleges. This analysis serves as our exploration of the data and our outcome of interest (md_earn_wne_p6 - the median earnings of graduates 6 years post graduation). 
...
14b. Did your updated two-predictor conditional model show an improvement over your last two models (unconditional and one-predictor)? How do you know? 
